...
function Input_Digit(digit) {
    ...
    //This overrides Display_Value if the current value is 0, otherwise it adds to it.
...
function Input_Decimal(dot) {
      ...
      //This ensures that accidental clicking of the decimal point does'nt cause bugs in the operation.
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the screen to a number and then store the result in Calculator.First_Operand if it does'nt already exist.
