...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/x.x.png")';
            //Active Player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
              select.style.backgroundImage = 'url("images/o.o.png")'; 
        }
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            //if the random number evaluated returns true, the square has'nt been selected yet.
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing() {
              ...
              if (x1 <= x2 && y1 <= y2) {
               ...
               //This condition is similar to yhe one above.
               //This is necessary for the 6, 4, 2 win condition.
        ...
        //This function clears our canvas after our line drawn.
        function clear() { 
